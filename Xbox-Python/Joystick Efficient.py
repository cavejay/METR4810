...
class App:
    def __init__(self):
        ...
        x = self.my_joystick.get_numaxes()
        print(x)
        self.screen = pygame.display.set_mode( (750,170) )
        ...
        while (True):
            ...
            for event in self.g_keys:
                if (event.type == KEYDOWN and event.key == K_ESCAPE):
                    ...
                    self.quit()
                    return
                elif (self.my_joystick.get_button(7)):
                    self.quit()
                    return
